      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-xl text-steel-500">
            Every production line loses output to scrap, rework, and recalls. To
            cover the risk, you inflate quotes - then lose contracts. With
            PartShield, you insure against quality failures so you can bid
            aggressively without fear of margin erosion.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="relative bg-white rounded-xl shadow-lg p-8 text-center border-t-4 border-red-500">
            ...
            <p className="text-steel-600">
              Defects, failed inspections, and potential recalls eat into
              margins unpredictably, forcing you to absorb costly rework or
              rerun entire production batches.
            </p>
          </div>
          ...
          <div className="relative bg-white rounded-xl shadow-lg p-8 text-center border-t-4 border-orange-500">
            ...
            <p className="text-steel-600">
              To shield against production-line scrap and warranty risk, you
              inflate bids with safety margins - only to lose contracts to
              leaner competitors.
            </p>
          </div>
          ...
          <div className="relative bg-white rounded-xl shadow-lg p-8 text-center border-t-4 border-growth-500 sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-steel-600">
              Transfer production quality risk to PartShield. Quote
              competitively, protect your bottom line, and scale production with
              confidence.
            </p>
          </div>
        </div>
